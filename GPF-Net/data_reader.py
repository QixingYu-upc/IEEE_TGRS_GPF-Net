...
class PaviaURaw(DataReader):
    def __init__(self):
        ...
        raw_data_package = sio.loadmat(r"/home/project/GNN_for_HSI/NL_GNN_for_HSI/Datasets/PaviaU/PaviaU.mat")
        self.data_cube = raw_data_package["paviaU"].astype(np.float32)
        truth = sio.loadmat(r"/home/project/GNN_for_HSI/NL_GNN_for_HSI/Datasets/PaviaU/PaviaU_gt.mat")
        # print(truth.keys())
...
class Salinas(DataReader):
    def __init__(self):
        ...
        raw_data_package = sio.loadmat(r"/home/project/GNN_for_HSI/NL_GNN_for_HSI/Datasets/Salinas/Salinas_corrected.mat")
        self.data_cube = raw_data_package["salinas_corrected"].astype(np.float32)
        truth = sio.loadmat(r"/home/project/GNN_for_HSI/NL_GNN_for_HSI/Datasets/Salinas/Salinas_gt.mat")
